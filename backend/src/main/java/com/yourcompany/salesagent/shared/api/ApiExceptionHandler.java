...
import com.yourcompany.salesagent.ai.application.TokenQuotaExceededException;
...
public class ApiExceptionHandler {
	...
	ProblemDetail handleTokenQuotaExceeded(TokenQuotaExceededException exception) {
